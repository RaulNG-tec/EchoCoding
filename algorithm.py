...
class Owner():
    # restaurante, espacio establecido, maxima ocupacion, distancia entre personas, porcentaje de ocupacion, office hours

    # funcion para estrablecer espacio {maxima ocupacion, distancia, porcentaje}
